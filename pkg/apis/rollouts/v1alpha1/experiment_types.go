...
type TemplateService struct {
	...
	// Changes the default port mappings between the service and the pod
	PortMappings []TemplateServicePortMapping `json:"portMappings,omitempty" protobuf:"bytes,2,rep,name=portMappings"`
}
